...
function inferProbeProtocol(
  ...
  if (
    normalizedSelector === 'openai' ||
    normalizedSelector === 'codex' ||
    normalizedSelector === 'dare' ||
    normalizedSelector === 'trae'
  ) {
    return 'openai';
  }
  ...
  if (
    normalizedHints.includes('codex') ||
    normalizedHints.includes('openai') ||
    normalizedHints.includes('dare') ||
    normalizedHints.includes('trae')
  ) {
    return 'openai';
  }
